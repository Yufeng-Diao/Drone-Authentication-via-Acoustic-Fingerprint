# -*- coding: utf-8 -*-
"""
Created on Tue Apr  5 22:04:39 2022
...
import toolbox.mfcc_sigproc as sigproc
...
def mfcc(signal,samplerate=16000,winlen=0.025,winstep=0.01,numcep=13,
    ...
    # This is ln(feat)
    feat = numpy.log(feat)
    # print('feat numpy.log= ', numpy.shape(feat))
    # print('feat numpy.log= ', feat)
    # This normalization equals to peak normalization
    feat = dct(feat, type=2, axis=1, norm='ortho')[:,:numcep]
    # print('feat dct= ', numpy.shape(feat))
    # print('feat dct= ', feat)
...
def fbank(signal,samplerate=16000,winlen=0.025,winstep=0.01,
    ...
    # print('frames = ', numpy.shape(frames))
    # print('frames = ', frames)
    frames = peak_norm(frames)
    # print('frames = ', numpy.shape(frames))
    # print('frames = ', frames)
    pspec = sigproc.powspec(frames,nfft)
    # print('pspec = ', numpy.shape(pspec))
    # print('pspec = ', pspec)
    energy = numpy.sum(pspec,1) # this stores the total energy in each frame
    energy = numpy.where(energy == 0,numpy.finfo(float).eps,energy) # if energy is zero, we get problems with log

    fb = get_filterbanks(nfilt,nfft,samplerate,lowfreq,highfreq)
    # print('fbank = ', numpy.shape(fb))
    # print('fbank = ', fb)
    feat = numpy.dot(pspec,fb.T) # compute the filterbank energies
    # print('feat = ', numpy.shape(feat))
    # print('feat = ', feat)
...
def peak_norm(frames):
    frames_norm = normalize(frames, axis=1, norm='max')
    return frames_norm
